...
#   Create a new GCP instance. If you want the test query--used to verify that
#   the script is succeeding--to work, make sure the include the proper scope.
#   It requires the "Stackdriver Monitoring API" to have "Full" scope.
#
